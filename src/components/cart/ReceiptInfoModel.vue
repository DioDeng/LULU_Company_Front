...
<template>
  <!-- 填寫基本資料 -->
  <h3 class="mb-2 headText">配送資訊：</h3>
  <div class="col-12">
    <div class="form-check">
      <input class="form-check-input h5" type="checkbox" id="gridCheck" />
      <label class="form-check-label h5" for="gridCheck"> 使用聯絡人資料 </label>
    </div>
  </div>
  <!-- v-slot="{ meta }" -->
  <VForm ref="formRef">
    <div class="form-floating mb-3">
      ...
      <label for="floatingInput">
        收件人姓名、或公司<ErrorMessage name="姓名或公司" class="text-danger ms-3" />
      </label>
    </div>
    <div class="form-floating mb-3">
      <VField name="電話" type="text" rules="required" class="form-control bg-body-tertiary" />
      <label for="floatingInput">
        收件人電話<ErrorMessage name="電話" class="text-danger ms-3" />
      </label>
    </div>
    <!-- 地址 -->
    ...
    <div class="form-floating mb-3">
      <VField name="地址" type="text" rules="required" class="form-control bg-body-tertiary" />
